...
class ECBAttackerSpec extends CryptoSpec {
  ...
  "shorter suffix" should "be same for first n bytes" in {
    ...
    val key1 = "abcdefgh"
    val suffix1 = "123456"
    val attacker1 = new Attacker(new Oracle(key1, suffix1))
    ...
    val attacker2 = new Attacker(new Oracle(key2, suffix2))
  ...
  "byte suffix" should "be decrypted" in {
    ...
    val attacker = new Attacker(new Oracle(key, suffix))
